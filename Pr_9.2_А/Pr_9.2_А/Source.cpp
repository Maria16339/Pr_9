...
bool Bin_Search(Students* S, const int N, const string surname, const int course, double Avarage_grade);
int main()
{
    SetConsoleCP(1251);
    ...
    do
    {
        ...
        case 5:
...

            {
                ...
                cout << "Курс: "; cin >> B_course;

            } while (B_course < 0 || B_course > 4);

            do

            {

                cout << "Середній бал: "; cin >> Avarage_grade; cout << endl;

            } while (Avarage_grade < 0 || Avarage_grade > 5);

            if (Bin_Search(S, N, B_surname, B_course, Avarage_grade) == 1)
...

{
    ...
    return (S[i].grade_math * 1. + S[i].grade_physics * 1. + S[i].grade_computer_science * 1.) / 3.;
...

{
...

    {
        ...
        cout << "|" << setw(6) << S[i].grade_computer_science << setw(6);

        cout << "|" << setw(6) << Avarage_grade(S, i) << setw(6) << "|" << endl;
...

        {
            ...
            if ((S[i1].course > S[i1 + 1].course)
                ...
                ((S[i1].course == S[i1 + 1].course)
                    ...
                    (S[i1].Avarage_grade > S[i1 + 1].Avarage_grade))
...

{
...

    {
        ...
        for (j = i - 1;
            ...
            j > 0 && ((S[I[j]].course > S[value].course)
                ...
                ((S[I[j]].course == S[value].course)
                    ...
                    (S[I[j]].Avarage_grade > S[value].Avarage_grade))
...

{
...

    {
        ...
        cout << "|" << setw(6) << S[I[i]].grade_computer_science << setw(6);
...
bool Bin_Search(Students* S, const int N, const string surname, const int course, double Avarage_grade)
{
    ...
    do
    {
        ...
        if ((S[m].surname == surname
            ...
            S[m].course == course)
            &&
            (S[m].Avarage_grade == Avarage_grade))
        {
            return 1;
        }
        if ((S[m].Avarage_grade < Avarage_grade)
            ||
            (S[m].Avarage_grade == Avarage_grade
                &&
                S[m].course < course)
